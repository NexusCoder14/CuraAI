// Centralized prompt templates for CURA AI.
// Each prompt is tuned for a specific Groq-powered capability and forces
// well-structured outputs so downstream UIs are deterministic to render.
...
export const PERSONA_PROMPT = (profile: Record<string, unknown>) => `
...
export const ROADMAP_PROMPT = (goal: string, days: number, profile?: Record<string, unknown>) => `
...
- Phase names should escalate toward the goal.`;

export const MATCH_PROMPT = (twin: unknown, salons: unknown, filters: unknown) => `
...
export const LOOK_PROMPT = (description: string) => `
...
export const INSIGHTS_PROMPT = (twin: unknown, activity: unknown) => `
